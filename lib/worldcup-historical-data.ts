...
export const PLAYER_WORLD_CUP_CAREERS: PlayerWorldCupCareer[] = [
  ...
  },
  {
    ...
    lastTournament: 0,
    careerSummary:
      'Italy missed 2018 and 2022 World Cups â€” Chiesa has no WC appearances yet. Euro 2020 winner with 2 goals in that tournament. Italy did not qualify for 2026.',
    appearances: [],
    dataSource: SOURCE,
  },
  {
